    ...
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border border-gray-300 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        ...
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[40px_1fr_80px_1fr_1fr_80px_80px] items-center gap-x-6 text-gray-600 py-4 border-b hover:bg-gray-50' key={index}>
            <p className='max-sm:hidden text-center pl-4'>{index + 1}</p>

  ...
  return (
    <div>
      ...
      <div className='flex flex-col items-start justify-center gap-6'>
        ...
        <p className='text-gray-600'>411037 Hamal Nagar <br />Market Yard, PUNE</p>
        <p className='text-gray-600'>Tel: +919284780510 <br /> Email: tejassalunkhe92389239@gmail.com</p>

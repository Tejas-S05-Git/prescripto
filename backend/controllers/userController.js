...
const updateProfile = async (req, res) => {
    try {
        ...
        const userId = req.user.id   // 🔥 FIX 1
...
const bookAppointment = async (req, res) => {
    try {
        ...
        // chekking for slot availability
...
const cancelAppointment = async (req, res) => {
  try {
    ...
    // prevent double cancel (optional but recommended)
...
// API to make paymnet of appointments using razorpay
